...
const ContactForm = ({ closeModal }) => {
  return (
    <div className="bg-black bg-opacity-[0.5] w-screen h-screen fixed top-0 left-0 z-[9999] font-russo ">
      <div className="bg-white fixed top-0 bottom-0 m-auto h-[95%] left-0 right-0 px-[12%] rounded-[25px]">
